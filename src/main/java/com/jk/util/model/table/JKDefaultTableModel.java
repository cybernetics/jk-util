...
public class JKDefaultTableModel extends AbstractTableModel implements Serializable {
	 ...
	 * @see #setValueAt
	 */
	public JKDefaultTableModel(final int rowCount, final int columnCount) {
	 ...
	 * @see #setValueAt
	 */
	public JKDefaultTableModel(final Object[] columnNames, final int rowCount) {
	 ...
	 * @see #setDataVector
	 */
	public JKDefaultTableModel(final Object[][] data, final Object[] columnNames) {
	 ...
	 * @see #setValueAt
	 */
	public JKDefaultTableModel(final Vector columnNames, final int rowCount) {
	 ...
	 * @see #setDataVector
	 */
	public JKDefaultTableModel(final Vector data, final Vector columnNames) {
		setDataVector(data, columnNames);
	}
